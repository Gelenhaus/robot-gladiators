...
var endGame = function () {
    ...
    if (playerHealth > 0) {
        window.alert("Nice, you survived! You finished with a score of " + playerMoney + ".");
    }
    else {
...
var shop = function () {
    ...
    switch (shopOptionPrompt) {
        ...
        case "REFILL":
            if (playerMoney > 7) {
                window.alert("Adding 20 health for 7 dollars");
                playerHealth = playerHealth + 20;
                playerMoney = playerMoney - 7;
            }
            else {
                window.alert("You do not have enought money!");
            }
            break;
        case "upgrade":
        case "UPGRADE":
            if (playerMoney > 7) {
                window.alert("Increasing your attack by 6 for 7 dollars");
                playerAttack = playerAttack + 6;
                playerMoney = playerMoney - 7;
            }
            else {
                window.alert("You dont have the cash brah!");
            }
            break;
        case "leave":
        case "LEAVE":
